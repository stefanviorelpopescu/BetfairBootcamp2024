package org.example.concurrency._7_concurrency.src.main.java.code._1_study._8_livelock;
...
public class TransactionThread extends Thread {
    ...
    private boolean transferUsingLockObjects(BankAccount from, BankAccount to, int amount) {
        ...
        if (from.lock()) {
            ...
            if (!success) {
                from.deposit(amount); //in the case deposit was not successful, then we put the money back
            }
            from.unlock();
        }
